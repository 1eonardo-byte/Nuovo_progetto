...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errori)) {
        ...
        $sql = "UPDATE autori SET nome = ?, cognome = ?, nazionalita = ?, data_nascita = ? WHERE id_autore = ?";
    ...
    $sql = "SELECT nome, cognome, nazionalita, data_nascita FROM autori WHERE id_autore = ?";
    $stmt = mysqli_prepare($conn, $sql);
